...
'settings.engine.test_failed': 'Connection failed: {error}',
    ...
    'settings.users_tab': 'User Management',
    'settings.oauth_tab': 'OAuth Settings',
...
'settings.security.provider': 'LLM Provider',
    ...
    'settings.security.concurrency': 'Security audit concurrency',
    'settings.security.concurrency_desc': 'Number of parallel security audit worker slots (runtime configurable)',
    'settings.translation.concurrency': 'Translation concurrency',
    'settings.translation.concurrency_desc': 'Number of parallel translation worker slots (runtime configurable)',
    ...
    'users.reject': 'Reject',
    'users.approve_confirm': 'Are you sure you want to approve this user?',
    'users.reject_confirm': 'Are you sure you want to reject this user?',
    'users.approve_success': 'User approved successfully',
    'users.reject_success': 'User rejected successfully',
    'users.approve_failed': 'Failed to approve user',
    'users.reject_failed': 'Failed to reject user',
    ...
    'users.user_required': 'Username is required',
    'users.password_required': 'Password is required for new users',
    ...
    'oauth.subtitle': 'Configure third-party authentication providers and LDAP/AD integration.',
    'oauth.save_changes': 'Save Changes',
    'oauth.ldap_title': 'LDAP / Active Directory',
    'oauth.ldap_enable': 'Enable LDAP Authentication',
    'oauth.ldap_desc': 'Allow users to log in with their corporate directory credentials.',
    'oauth.ldap_server': 'Server URL',
    'oauth.ldap_base_dn': 'Base DN',
    'oauth.ldap_bind_dn': 'Bind DN',
    'oauth.ldap_bind_password': 'Bind Password',
    'oauth.ldap_bind_optional': 'Optional: Bind account used to search user directory. If not set, users will directly use AD account password for login verification.',
    'oauth.social_providers': 'Social Providers',
    'oauth.google': 'Google Workspace',
    'oauth.google_desc': 'Sign in with Google account',
    'oauth.github': 'GitHub',
    'oauth.github_desc': 'Sign in with GitHub account',
    'oauth.microsoft': 'Microsoft Azure AD',
    'oauth.microsoft_desc': 'Sign in with Microsoft account',
    'oauth.wechat': 'WeChat Work / Enterprise',
    'oauth.wechat_desc': 'Sign in with WeChat Work',
    'oauth.client_id': 'Client ID',
    'oauth.client_secret': 'Client Secret',
    'oauth.corp_id': 'CorpID',
    'oauth.save_success': 'OAuth settings saved successfully',
    'oauth.save_failed': 'Failed to save OAuth settings',
    'oauth.load_failed': 'Failed to load OAuth configuration',

    // Login page OAuth buttons
    'login.ldap': 'Login with LDAP/AD',
    'login.google': 'Continue with Google',
    'login.microsoft': 'Continue with Microsoft',
    'login.github': 'Continue with GitHub',
    'login.wechat': 'Continue with WeChat',
    'login.register_link': "Don't have an account? Sign up",
    'register.title': 'Create Account',
    'register.subtitle': 'Enter your credentials to register',
    ...
    'register.error_generic': 'Registration failed. Please try again.',
    'register.username_placeholder': 'Enter your username',
    'register.email_placeholder': 'Enter your email (optional)',
    'register.password_placeholder': '••••••••',
    'register.captcha_placeholder': 'Enter captcha',
  },
  zh: {
    'nav.logo': 'SKILLS RAG',
    'nav.registry': '技能注册表',
...
'settings.engine.test_failed': '连接失败：{error}',
    ...
    'settings.users_tab': '用户管理',
    'settings.oauth_tab': 'OAuth 设置',
...
'settings.security.provider': '大模型提供商',
    ...
    'settings.security.concurrency': '安全审计并发数',
    'settings.security.concurrency_desc': '并行安全审计工作槽数量（运行时可配置）',
    'settings.translation.concurrency': '翻译并发数',
    'settings.translation.concurrency_desc': '并行翻译工作槽数量（运行时可配置）',
    ...
    'users.actions': '操作',
    'users.loading': '加载用户中...',
    'users.no_found': '未找到用户。',
    'users.active': '已启用',
    'users.status_pending': '待审核',
    'users.status_active': '已激活',
    'users.status_disabled': '已禁用',
    'users.approve': '批准',
    'users.reject': '拒绝',
    'users.approve_confirm': '确定要批准该用户吗？',
    'users.reject_confirm': '确定要拒绝该用户吗？',
    'users.approve_success': '用户批准成功',
    'users.reject_success': '用户拒绝成功',
    'users.approve_failed': '批准用户失败',
    'users.reject_failed': '拒绝用户失败',
    'users.disabled': '已禁用',
    'users.edit_user': '编辑用户',
    'users.add_new_user': '添加新用户',
    'users.password': '密码',
    'users.password_hint': '(留空保持不变)',
    'users.enter_password': '输入密码',
    'users.role_admin': '管理员',
    'users.role_user': '普通用户',
    'users.cancel': '取消',
    'users.save_changes': '保存更改',
    'users.user_required': '用户名不能为空',
    'users.password_required': '新用户必须设置密码',
    'users.update_success': '用户更新成功',
    'users.create_success': '用户创建成功',
    'users.delete_success': '用户删除成功',
    'users.save_failed': '保存用户失败',
    'users.delete_failed': '删除用户失败',
    'users.load_failed': '加载用户失败',
    'users.delete_confirm': '确定要删除此用户吗？此操作无法撤销。',

    // OAuth Settings
    'oauth.title': 'OAuth 设置',
    'oauth.subtitle': '配置第三方身份验证提供者和 LDAP/AD 集成。',
    'oauth.save_changes': '保存更改',
    'oauth.ldap_title': 'LDAP / Active Directory',
    'oauth.ldap_enable': '启用 LDAP 身份验证',
    'oauth.ldap_desc': '允许用户使用企业目录凭据登录。',
    'oauth.ldap_server': '服务器地址',
    'oauth.ldap_base_dn': '基础 DN',
    'oauth.ldap_bind_dn': '绑定 DN',
    'oauth.ldap_bind_password': '绑定密码',
    'oauth.ldap_bind_optional': '可选：绑定账户用于搜索用户目录。不设置时，用户将直接使用 AD 账号密码登录验证。',
    'oauth.social_providers': '社交登录',
    'oauth.google': 'Google 工作区',
    'oauth.google_desc': '使用 Google 账号登录',
    'oauth.github': 'GitHub',
    'oauth.github_desc': '使用 GitHub 账号登录',
    'oauth.microsoft': 'Microsoft Azure AD',
    'oauth.microsoft_desc': '使用 Microsoft 账号登录',
    'oauth.wechat': '企业微信',
    'oauth.wechat_desc': '使用企业微信登录',
    'oauth.client_id': '客户端 ID',
    'oauth.client_secret': '客户端密钥',
    'oauth.corp_id': '企业 ID',
    'oauth.save_success': 'OAuth 设置保存成功',
    'oauth.save_failed': '保存 OAuth 设置失败',
    'oauth.load_failed': '加载 OAuth 配置失败',

    // Login page OAuth buttons
    'login.ldap': '使用 LDAP/AD 登录',
    'login.google': '使用 Google 继续',
    'login.microsoft': '使用 Microsoft 继续',
    'login.github': '使用 GitHub 继续',
    'login.wechat': '使用微信继续',
    'login.register_link': '还没有账户？去注册',
    'register.title': '创建账户',
    'register.subtitle': '输入您的详细信息以注册',
    ...
    'register.success': '注册成功！请等待管理员批准。',
    'register.error_password_mismatch': '两次输入的密码不一致',
    'register.error_generic': '注册失败，请重试。',
    'register.username_placeholder': '输入用户名',
    'register.email_placeholder': '输入电子邮箱（可选）',
    'register.password_placeholder': '••••••••',
    'register.captcha_placeholder': '输入验证码',
  },
};
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const t = (key: string, params?: Record<string, string | number>) => {
    const langDict =
      (translations as unknown as Record<string, Record<string, string>>)[language] ||
      (translations as unknown as Record<string, Record<string, string>>)['en'];
